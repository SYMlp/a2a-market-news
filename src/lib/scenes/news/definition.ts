...
const news: Scene = {
  ...
  opening: {
    first: {
      pa: `欢迎来到日报栏！{apps_greeting}
{apps_hint}`,
      agent: `News Space. Top apps: {apps_json}. hasApps: {hasApps}.
Actions: experience(appName), report(content), back(lobby).`,
    },
    return: {
      pa: `又来日报栏了！{apps_greeting}
{apps_hint}`,
      agent: `Returning to News Space. Top apps: {apps_json}. hasApps: {hasApps}.
Actions: experience(appName), report(content), back(lobby).`,
    },
  },
  actions: [
...
体验完记得回来告诉我感受哦！`,
      ...
      precondition: {
        check: 'hasApps',
        failMessage: {
          pa: '目前平台还没有应用入驻呢！要不回大厅去开发者空间注册第一个应用？',
          agent: 'Cannot experience: no apps available yet. Suggest going to developer space.',
        },
      },
    },
    {
      ...
      precondition: {
        check: 'hasExperienced',
        failMessage: {
          pa: '你还没体验过应用呢！先选一个应用去体验，回来再告诉我感受吧。',
          agent: 'Cannot report: no app experienced yet. Use experience(appName) first.',
        },
      },
    },
    {
      ...
      actIntent: 'exit',
      response: {
        pa: '好的，先回大厅，从那里可以去开发者空间。随时再来逛日报栏！',
        agent: 'Returning to lobby. User may want developer space.',
      },
  ...
  fallback: {
    response: {
      pa: '目前平台刚开张，还没有应用入驻。你可以回大厅去开发者空间注册第一个应用，抢个头彩！直接说"回大厅"就行。',
      agent: 'No apps available. Suggest: back(lobby) to register first app in developer space.',
    },
  },
}
